...
<https://sc1.checkpoint.com/documents/latest/APIs/index.html#cli/add-tacacs-server~v2.1>
...
API 2.0 R82 is GA and additional adjustments are work-in-progress (WIP)
API 2.1 R82.10 is GA and additional adjustments are work-in-progress (WIP)
API 2.2 R82.20 is in Public EA (at this date, 2026-07-15) and additional adjustments are work-in-progress (WIP)