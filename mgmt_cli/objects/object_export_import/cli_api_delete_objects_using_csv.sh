...
DeleteSimpleObjects () {
    ...
    echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} 'DeleteSimpleObjects : Done with Deleting '${APICLIobjecttype}' ( '${APICLIexportnameaddon}' ) using CSV File : '${APICLIDeleteCSVfile} | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
    ...
    if [ ${errorreturn} != 0 ] ; then
        ...
        if ${ABORTONERROR} ; then
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Error { '${errorreturn}' } in DeleteSimpleObjects procedure' | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            ...
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Error { '${errorreturn}' } in DeleteSimpleObjects procedure, but continueing' | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            #return ${errorreturn}
        fi
    fi
...
DeleteComplexObjects () {
    ...
    if [ $(expr ${APIobjectminversion} '<=' ${CurrentAPIVersion}) -eq 1 ] ; then
        ...
        echo `${dtzs}`${dtzsep} 'Delete '${APICLIcomplexobjectstype}' '${APICLICSVobjecttype}' from CSV File : "'${APICLIImportCSVfile}'"' | tee -a -i ${logfilepath}
        ...
        if [ ${errorreturn} != 0 ] ; then
            # Something went wrong, terminate
            echo `${dtzs}`${dtzsep} 'DeleteComplexObjects : Problem during publish operation! error return = { '${errorreturn}' }' | tee -a -i ${logfilepath}
        ...
        echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} 'DeleteComplexObjects : Done with Deleting '${APICLIcomplexobjectstype}' '${APICLICSVobjecttype}' ( '${APICLIexportnameaddon}' ) using CSV File : '${APICLIImportCSVfile} | tee -a -i ${logfilepath}
