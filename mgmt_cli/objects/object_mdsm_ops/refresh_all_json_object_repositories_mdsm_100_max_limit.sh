...
# MODIFIED 2025-06-18:03 - MDSM Specific

export test_script_work_dir_exp=object_mdsm_export
export test_script_work_folder=./${test_script_work_dir_exp}

if [ -r "cli_api_export_all_domains_objects.sh" ] ; then
    # found the script in the local directory, use that
    #export test_script_work_folder=.
    export test_script_work_folder=`pwd`
elif [ -r "./${test_script_work_dir_exp}/cli_api_export_all_domains_objects.sh" ] ; then
    # found the script in the local directory, use that
    #export test_script_work_folder=.
