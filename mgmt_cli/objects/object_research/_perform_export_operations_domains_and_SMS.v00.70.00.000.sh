...
#
#
# -#- Start Making Changes Here -#- Perform Export Operations for Domains and SMS servers
#
...
ScriptName=_perform_export_operations_domains_and_SMS.v${ScriptVersion}
export APIScriptFileNameRoot=_perform_export_operations_domains_and_SMS
export APIScriptShortName=_perform_export_operations_domains_and_SMS
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Perform Export Operations for Domains and SMS servers"
