...
#
#
# -#- Start Making Changes Here -#- Perform Export Operations for MDSM servers
#
...
ScriptName=_perform_export_operations_MDSM.v${ScriptVersion}
export APIScriptFileNameRoot=_perform_export_operations_MDSM
export APIScriptShortName=_perform_export_operations_MDSM
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Perform Export Operations for MDSM servers"
