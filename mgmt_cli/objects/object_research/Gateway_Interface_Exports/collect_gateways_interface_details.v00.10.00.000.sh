...
#
# SCRIPTS - Collect Gateway Interface Details
#
#
...
# -#- Start Making Changes Here -#- 
#
export MainObjectUC=Gateway
export MainObjectLC=gateway
export MainObjectsUC=Gateways
export MainObjectsLC=gateways
...
# -#- Start Making Changes Here -#- 
#
export OBJECTNAME="gateway"
export OBJECTSNAME="gateways"
export OBJECTSTYPE="simple-gateway"
export OBJECTSTYPES="simple-gateways"
