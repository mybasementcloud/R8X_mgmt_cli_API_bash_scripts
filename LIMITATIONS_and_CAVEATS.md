# LIMITATIONS and CAVEATS (v00.xx.yy.zzz)
...
The author is currently utilizing R82.10 with API version 2.1 and these limitations and caveats are based on current experience on this level of implementation for the R8X API.

Currently, R82.10 GA T467 JHF N/A Take is implemented for testing
