# R8x-export-import-api-scripts - What's NEW in v00.70.00
...
- Corrected issues with json export of simple-gateways from domain "System Data", where details-level standard is the only supported details-level
